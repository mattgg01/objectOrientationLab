...
favoriteThings.show = 'Regular Show'
...
let cat1 = new Cat('Whiskers', 2, 'black')
...
let wiz1 = new Wizard('Jake', 24, 'Levioso')
wiz1.castSpell()
...
//Code Here
let phone1 = new Phone('Apple', 'iPhone 12 Pro Max', 128, 'black', 400)
let phone2 = new Phone('Samsung', 'Samsung Galaxy 20', 256, 'blue', 600)
let phone3 = new Phone('Motorola', 'Flip Phone 5', 16, 'red', 45)
...
class Vehicle{
  ...
  move(miles){
    this.mileage += miles
    console.log(`New mileage is ${this.mileage}`)
  }
}
let car1 = new Vehicle(5, 'blue', 20)
car1.move(30)
...
//Code Here
let myFirstVehicle = new Vehicle(5, 'blue', 4000)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2, 'black', 4000, 'Harley')

/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/
myFirstMotorcycle.move(9000)
